...
const redirectToLoginIfUnauthorized = (error: unknown) => {
  ...
  if (error.message === UNAUTHED_ERR_MSG && window.location.pathname !== "/signin") window.location.href = "/signin";
};
...
const trpcClient = trpc.createClient({
  links: [httpBatchLink({ url: "/api/trpc", transformer: superjson, fetch(input, init) {
