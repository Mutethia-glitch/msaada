  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="impact-section container"><div className="impact-panel"><div className="impact-copy"><span className="section-kicker light">03 / The loop closed</span><h2>Good help deserves<br /><em>a clear ending.</em></h2><p>Read a documented Kibera case study: safe water, sanitation education, and a measurable reduction in diarrheal disease.</p><Link href="/impact/kibera-water" className="button button-cream">See the Kibera impact story <ArrowRight size={17} /></Link></div><div className="impact-metrics"><div><strong>250k</strong><span>residents using SODIS</span></div><div><strong>20%</strong><span>reported diarrhea reduction</span></div><div><strong>2</strong><span>Kibera villages studied</span></div></div><div className="impact-orb orb-one" /><div className="impact-orb orb-two" /></div></section>
